...
const TournamentFillingUp = (props: {
    ...
    return (
        <>
            ...
            <div className="my-4 text-lg text-yellow-600 dark:text-yellow-400">The tournament is not full yet. Please wait for more teams to join.</div>
            <div className="w-full h-full flex flex-row flex-wrap gap-4 mt-8 justify-center">
                ...
                })}
                {
                    ...
                    [...Array(props.tournament.type - fresh_tournament_data.teams.length)].map((e, i) =>
                        <div key={i} style={{ borderColor: 'gray' }} className={" border-2 card w-24 h-36 bg-base-100 dark:bg-gray-900 shadow-xl"}>
                        </div>
                    )
                }
